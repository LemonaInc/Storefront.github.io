        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url('cars'); ?>"><i class="fa fa-circle-o"></i> View All Cars</a></li>
                <li><a href="<?php echo base_url('cars/add'); ?>"><i class="fa fa-circle-o"></i> Add New Car</a></li>
              </ul>
            </li>
