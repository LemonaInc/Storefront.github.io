...
class Cars extends CI_Controller {
    ...
    function add() {
        ...
        if($this->input->post('sf')=='1'):
            ...
            if($address2==''){ $errors .= '<li>Enter Address Line 2</li>'; }
            ...
            if($errors!=''){
                ...
                if($count!=''){
                    ...
                    if($file_status!=true){
                        ...
                        $data['error'] = '<div class="alert alert-success">Car Created Successfully</div>';
                        $data['flush']  = true;
                    }
    ...
    function edit($car_number) {
        ...
        if($this->input->post('sf')=='1'):
            ...
            if($status==''){ $errors .= '<li>Enter Car Availability</li>'; }
            ...
            if($errors!=''){
                ...
                if($count!=''){
                    ...
                    $data['error'] = '<div class="alert alert-success">Car Updated Successfully</div>';
